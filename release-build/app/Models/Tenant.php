...
class Tenant extends Model
{
    ...
    public function getUrl(): string
    {
        if ($this->custom_domain) {
            ...
            // In local, keep lvh.me URLs on the dev server port (e.g. :8000).
            if (app()->environment('local') && str_ends_with($this->custom_domain, '.lvh.me') && $port) {
                return $scheme . '://' . $this->custom_domain . ':' . $port;
            }
