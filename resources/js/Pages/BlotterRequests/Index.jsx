                            ...
                            items.map((req) => (
                                <tr key={req.id}>
                                    <td className="px-4 py-2">
                                        <Link
                                            href={`/incidents/${req.incident?.id}`}
                                    ...
                                    <td className="px-4 py-2">
                                        <span
                                            className={`rounded px-2 py-0.5 text-xs ${STATUS_CLASS[req.status] || "bg-slate-100 text-slate-800"}`}
                                        >
                                            {req.status}
                                        </span>
                                                ...
                                                <div className="flex flex-col items-end gap-2">
                                                    ...
                                                    <div>
                                                        <button
                                                            ...
                                                            onClick={() =>
                                                                router.post(
                                                                    `/blotter-requests/${req.id}/approve`,
                                                                    {
                                                                        remarks:
                                                                            remarksById[
                                                                                req
                                                        ...
                                                        <button
                                                            ...
                                                            onClick={() =>
                                                                router.post(
                                                                    `/blotter-requests/${req.id}/reject`,
                                                                    {
                                                                        remarks:
                                                                            remarksById[
                                                                                req
