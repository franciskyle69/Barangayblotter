    ...
    <div className="flex min-h-screen items-center justify-center bg-[#f9fafb] px-4 font-sans antialiased">
      <div className="w-full max-w-md">
        <div className="mb-8 flex flex-col items-center gap-3">
          ...
          <h1 className="text-center text-2xl font-bold text-slate-900">Malaybalay City Barangay Blotter</h1>
        </div>
        <div className="rounded-lg border border-slate-200/80 bg-white p-6 shadow-sm">
          ...
          <p className="mb-4 text-sm text-slate-600">Choose the barangay (Malaybalay City) you want to access.</p>
